...
[![tests](https://img.shields.io/badge/tests-138%20suites-brightgreen)](#validation)
[![checks](https://img.shields.io/badge/checks-108%2C258%20per%20run-brightgreen)](#validation)
[![reference data](https://img.shields.io/badge/reference%20data-396%20sets-blue)](#validation)
...
| What | Measured |
|---|---|
| Test suites | 138, all passing |
| Test cases | 935 |
| Checks executed per run | 108,258 |
| Assertion sites in the tests | 3,354 |
| Reference datasets (colour-science, OCIO, ACES-dev) | 396 |
...
**108,258 checks per run** is what actually executes, not what is written. A
...
./build/tests/Release/alwan_tests   # 138 test suites, single binary
```
...
- **Coverage:** canonical cases, edge cases, and sweeps for each
  module: 138 suites, 935 cases, 108,258 checks executed per run
...
+-- tests/                   # 138 test suites + reference fixtures
...
- [x] Unified test suite (138 suites, hosted in alwan_dev)
