...
[![tests](https://img.shields.io/badge/tests-141%20suites-brightgreen)](#validation)
[![checks](https://img.shields.io/badge/checks-108%2C337%20per%20run-brightgreen)](#validation)
[![reference data](https://img.shields.io/badge/reference%20data-399%20sets-blue)](#validation)
...
| What | Measured |
|---|---|
| Test suites | 141, all passing |
| Test cases | 948 |
| Checks executed per run | 108,337 |
| Assertion sites in the tests | 3,413 |
| Reference datasets (colour-science, OCIO, ACES-dev) | 399 |
...
**108,337 checks per run** is what actually executes, not what is written. A
...
./build/tests/Release/alwan_tests   # 141 test suites, single binary
```
...
- **Coverage:** canonical cases, edge cases, and sweeps for each
  module: 141 suites, 948 cases, 108,337 checks executed per run
...
+-- tests/                   # 141 test suites + reference fixtures
...
- [x] Unified test suite (141 suites, hosted in alwan_dev)
