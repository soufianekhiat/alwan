...
| Test cases | 959 |
| Checks executed per run | 108,418 |
| Assertion sites in the tests | 3,471 |
| Reference datasets (colour-science, OCIO, ACES-dev) | 409 |
| Embedded data tables | 762 |
| Exported symbols | 1,795 |
...
**108,418 checks per run** is what actually executes, not what is written. A
...
- **Coverage:** canonical cases, edge cases, and sweeps for each
  module: 143 suites, 959 cases, 108,418 checks executed per run
