...
[![tests](https://img.shields.io/badge/tests-125%20suites-brightgreen)](#validation)
[![checks](https://img.shields.io/badge/checks-96%2C812%20per%20run-brightgreen)](#validation)
[![reference data](https://img.shields.io/badge/reference%20data-370%20sets-blue)](#validation)
...
| What | Measured |
|---|---|
| Test suites | 125, all passing |
| Test cases | 894 |
| Checks executed per run | 96,812 |
| Assertion sites in the tests | 3,009 |
| Reference datasets (colour-science, OCIO, ACES-dev) | 370 |
...
**96,812 checks per run** is what actually executes, not what is written. A
...
./build/tests/Release/alwan_tests   # 125 test suites, single binary
```
...
- **Coverage:** canonical cases, edge cases, and sweeps for each
  module: 125 suites, 894 cases, 96,812 checks executed per run
...
+-- tests/                   # 125 test suites + reference fixtures
...
- [x] Unified test suite (125 suites, hosted in alwan_dev)
