...
[![tests](https://img.shields.io/badge/tests-130%20suites-brightgreen)](#validation)
[![checks](https://img.shields.io/badge/checks-101%2C794%20per%20run-brightgreen)](#validation)
[![reference data](https://img.shields.io/badge/reference%20data-375%20sets-blue)](#validation)
...
| What | Measured |
|---|---|
| Test suites | 130, all passing |
| Test cases | 908 |
| Checks executed per run | 101,794 |
| Assertion sites in the tests | 3,144 |
| Reference datasets (colour-science, OCIO, ACES-dev) | 375 |
| Embedded data tables | 747 |
| Exported symbols | 1,681 |
...
**101,794 checks per run** is what actually executes, not what is written. A
...
./build/tests/Release/alwan_tests   # 130 test suites, single binary
```
...
- **Coverage:** canonical cases, edge cases, and sweeps for each
  module: 130 suites, 908 cases, 101,794 checks executed per run
...
+-- tests/                   # 130 test suites + reference fixtures
...
- [x] Unified test suite (130 suites, hosted in alwan_dev)
