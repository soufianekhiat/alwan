...
[![tests](https://img.shields.io/badge/tests-135%20suites-brightgreen)](#validation)
[![checks](https://img.shields.io/badge/checks-104%2C943%20per%20run-brightgreen)](#validation)
[![reference data](https://img.shields.io/badge/reference%20data-393%20sets-blue)](#validation)
...
| What | Measured |
|---|---|
| Test suites | 135, all passing |
| Test cases | 922 |
| Checks executed per run | 104,943 |
| Assertion sites in the tests | 3,272 |
| Reference datasets (colour-science, OCIO, ACES-dev) | 393 |
| Embedded data tables | 761 |
| Exported symbols | 1,749 |
...
**104,943 checks per run** is what actually executes, not what is written. A
...
./build/tests/Release/alwan_tests   # 135 test suites, single binary
```
...
- **Coverage:** canonical cases, edge cases, and sweeps for each
  module: 135 suites, 922 cases, 104,943 checks executed per run
...
+-- tests/                   # 135 test suites + reference fixtures
...
- [x] Unified test suite (135 suites, hosted in alwan_dev)
