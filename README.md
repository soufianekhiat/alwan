...
[![tests](https://img.shields.io/badge/tests-124%20suites-brightgreen)](#validation)
[![checks](https://img.shields.io/badge/checks-96%2C754%20per%20run-brightgreen)](#validation)
[![reference data](https://img.shields.io/badge/reference%20data-369%20sets-blue)](#validation)
...
| What | Measured |
|---|---|
| Test suites | 124, all passing |
| Test cases | 892 |
| Checks executed per run | 96,754 |
| Assertion sites in the tests | 2,993 |
| Reference datasets (colour-science, OCIO, ACES-dev) | 369 |
| Embedded data tables | 747 |
| Exported symbols | 1,655 |
...
**96,754 checks per run** is what actually executes, not what is written. A
...
./build/tests/Release/alwan_tests   # 124 test suites, single binary
```
...
- **Coverage:** canonical cases, edge cases, and sweeps for each
  module: 124 suites, 892 cases, 96,754 checks executed per run
...
+-- tests/                   # 124 test suites + reference fixtures
...
- [x] Unified test suite (124 suites, hosted in alwan_dev)
