...
static int test_wcag_contrast_ratio(void) {
    ...
    {
        alwan_f64 cr = alwan_wcag_contrast_ratio_f64_v(
    ...
    {
        alwan_f64 cr1 = alwan_wcag_contrast_ratio_f64_v(
            ALWAN_LITERAL(0.2), ALWAN_LITERAL(0.8));
        alwan_f64 cr2 = alwan_wcag_contrast_ratio_f64_v(
...
static int test_apca_contrast(void) {
    ...
    /* Monotonicity: increasing contrast with increasing luminance difference */
    {
        ...
        alwan_f64 Lc3 = alwan_apca_contrast_f64_v(black, white);
