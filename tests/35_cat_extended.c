    ...
    alwan_f64 const *expected_adapted_data)
{
    ...
    alwan_f64 const adapted_tolerance = ALWAN_TEST_TOLERANCE;
    ...
    for (size_t i = 0; i < num_test_colors * 3; i++) {
        alwan_f64 color_diff = ALWAN_ABS(adapted_xyz[i] - expected_adapted_data[i]);
