...
static int test_hwb_roundtrip(void) {
    alwan_rgb_f64 rgb_in = { ALWAN_LITERAL(0.8), ALWAN_LITERAL(0.3), ALWAN_LITERAL(0.1) };
    alwan_hwb_f64 hwb = alwan_rgb_to_hwb_f64_v(rgb_in);
    alwan_rgb_f64 rgb_rt = alwan_hwb_to_rgb_f64_v(hwb);
...
static int test_hwb_api(void) {
    alwan_rgb_f64 rgb_in = { ALWAN_LITERAL(0.6), ALWAN_LITERAL(0.4), ALWAN_LITERAL(0.2) };
    alwan_hwb_f64 hwb_out;

    alwan_rgb_to_hwb_f64(&hwb_out, &rgb_in);

    alwan_rgb_f64 rgb_rt;
    alwan_hwb_to_rgb_f64(&rgb_rt, &hwb_out);
...
static int test_d_series_known(void) {
    ...
    alwan_vec2_f64 d65 = alwan_d_series_xy_f64_v(ALWAN_LITERAL(6504.0));
    ...
    alwan_vec2_f64 d50 = alwan_d_series_xy_f64_v(ALWAN_LITERAL(5003.0));
...
static int test_d_series_range(void) {
    ...
    for (int i = 0; i < 6; i++) {
        alwan_vec2_f64 xy = alwan_d_series_xy_f64_v(ccts[i]);
