...
static int test_hellwig2022_forward(void) {
    ...
    for (size_t i = 0; i < num_test_cases; i++) {
        ...
        int status = alwan_hellwig2022_forward(&xyz_in, &vc, &corr);
