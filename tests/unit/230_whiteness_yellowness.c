 ...
 *
 * Test 230: Whiteness & Yellowness Indices (P4.6)
 */
...
#include "reference_values/yellowness_d65_10deg.csv"
    ...
    for (int i = 0; i < num_tests; i++) {
        ...
        alwan_scalar diff_c_2 = ALWAN_FABS(result_c_2 - expected_c_2);
        ...
        alwan_scalar diff_d65_2 = ALWAN_FABS(result_d65_2 - expected_d65_2);
        ...
        alwan_scalar diff_c_10 = ALWAN_FABS(result_c_10 - expected_c_10);
        ...
        alwan_scalar diff_d65_10 = ALWAN_FABS(result_d65_10 - expected_d65_10);
...
int test_230_whiteness_yellowness_main(void) {
    int failures = 0;
