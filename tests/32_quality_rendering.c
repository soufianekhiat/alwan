...
static int test_cri_d65(void) {
    ...
    alwan_f64 ra = alwan_cri_ra(ctx, &d65_spd);
...
static int test_cri_blackbody(void) {
    ...
    for (int i = 0; i < num_tests; i++) {
        ...
        alwan_f64 ra = alwan_cri_ra(ctx, &bb_spd);
...
static int test_cri_illuminant_a(void) {
    ...
    alwan_f64 ra = alwan_cri_ra(ctx, &a_spd);
...
static int test_cqs_d65(void) {
    ...
    alwan_f64 cqs = alwan_cqs_calculate(ctx, &d65_spd);
    printf("  D65 CQS = %.2f\n", cqs);
...
static int test_cqs_blackbody(void) {
    ...
    alwan_f64 cqs = alwan_cqs_calculate(ctx, &bb_spd);
...
static int test_tm30_d65(void) {
    ...
    alwan_f64 rf = alwan_tm30_rf(ctx, &d65_spd);
...
static int test_tm30_blackbody(void) {
    ...
    alwan_f64 rf = alwan_tm30_rf(ctx, &bb_spd);
...
static int test_cie224_d65(void) {
    ...
    alwan_f64 rf = alwan_cie224_rf(ctx, &d65_spd);
    TEST_ASSERT(rf >= ALWAN_LITERAL(95.0) && rf <= ALWAN_LITERAL(105.0),
...
static int test_tm30_cie224_match(void) {
    ...
    alwan_f64 tm30 = alwan_tm30_rf(ctx, &d65_spd);
    alwan_f64 cie224 = alwan_cie224_rf(ctx, &d65_spd);

    alwan_f64 diff = ALWAN_ABS(tm30 - cie224);
    TEST_ASSERT(diff < ALWAN_TEST_TOLERANCE,
...
static int test_ssi_perfect_match(void) {
    ...
    alwan_f64 ssi = alwan_ssi_calculate(ctx, &d65_spd1, &d65_spd2);
...
static int test_ssi_illuminant_pairs(void) {
    ...
    alwan_f64 ssi_d65_d50 = alwan_ssi_calculate(ctx, &d65_spd, &d50_spd);
    ...
    alwan_f64 ssi_d65_a = alwan_ssi_calculate(ctx, &d65_spd, &a_spd);
    ...
    alwan_f64 ssi_bb_d65 = alwan_ssi_calculate(ctx, &bb_spd, &d65_spd);
...
static int test_metamerism_basic(void) {
    ...
    alwan_f64 mi = alwan_metamerism_index(ctx, &refl1, &refl2, &d65_spd, &a_spd,
...
static int test_ssi_null_inputs(void) {
    ...
    alwan_f64 result = alwan_ssi_calculate(ctx, NULL, &d65_spd);
...
static int test_metamerism_null_inputs(void) {
    ...
    alwan_f64 result = alwan_metamerism_index(ctx, NULL, &refl_spd, &d65_spd, &d65_spd,
                                                 ALWAN_OBSERVER_CIE_1931_2DEG);
    TEST_ASSERT(result < ALWAN_LITERAL(0.0),
...
static int test_cqs_null_inputs(void) {
    ...
    alwan_f64 result = alwan_cqs_calculate(ctx, NULL);
    TEST_ASSERT(result < ALWAN_LITERAL(0.0),
...
static int test_tm30_null_inputs(void) {
    ...
    alwan_f64 result = alwan_tm30_rf(ctx, NULL);
    TEST_ASSERT(result < ALWAN_LITERAL(0.0),
...
static int test_cie224_null_inputs(void) {
    ...
    alwan_f64 result = alwan_cie224_rf(ctx, NULL);
    TEST_ASSERT(result < ALWAN_LITERAL(0.0),
