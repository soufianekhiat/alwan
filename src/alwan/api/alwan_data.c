...
/* Von Kries CAT matrix: the Hunt-Pointer-Estevez matrix normalised to equal energy, which
 * the CIE 1994 and Fairchild 1990 adaptation models both work in. The CSV was already
 * being generated by gendata/data/cat_matrices.py; nothing read it until now. */
#if ALWAN_WITH_F32
alwan_f32 const g_cat_von_kries_f32[9] = {
#include "../data/matrices/cat_von_kries.csv"
};
#endif
#if ALWAN_WITH_F64_FACADE
alwan_f64 const g_cat_von_kries_f64[9] = {
#include "../data/matrices/cat_von_kries.csv"
};
#endif
