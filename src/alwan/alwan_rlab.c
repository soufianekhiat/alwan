...
int alwan_rlab_inverse(alwan_rlab_correlates const *correlates,
    ...
    xyz_ref.v[0] = ALWAN_POW(ALWAN_FABS(xyz_ref_sigma.v[0]), inv_sigma);
    xyz_ref.v[1] = ALWAN_POW(ALWAN_FABS(xyz_ref_sigma.v[1]), inv_sigma);
    xyz_ref.v[2] = ALWAN_POW(ALWAN_FABS(xyz_ref_sigma.v[2]), inv_sigma);
