...
int alwan_xyz_to_jzazbz_map(alwan_scalar *jzazbz_out, alwan_scalar const *xyz_in,
...
int alwan_jzazbz_to_xyz_map(alwan_scalar *xyz_out, alwan_scalar const *jzazbz_in,
                             size_t count, size_t in_stride, size_t out_stride) {
...
int alwan_jzazbz_to_jzczhz_map(alwan_scalar *jzczhz_out, alwan_scalar const *jzazbz_in,
                                size_t count, size_t in_stride, size_t out_stride) {
...
int alwan_jzczhz_to_jzazbz_map(alwan_scalar *jzazbz_out, alwan_scalar const *jzczhz_in,
                                size_t count, size_t in_stride, size_t out_stride) {
