...
ALWAN_MAP3_EX_V(alwan_rgb_to_cmy_map_ex,   alwan_rgb, alwan_cmy, alwan_rgb_to_cmy_v, r,g,b, c,m,y)
ALWAN_MAP3_EX_V(alwan_cmy_to_rgb_map_ex,   alwan_cmy, alwan_rgb, alwan_cmy_to_rgb_v, c,m,y, r,g,b)
ALWAN_MAP3_EX_V(alwan_rgb_to_ycocg_map_ex, alwan_rgb, alwan_ycocg, alwan_rgb_to_ycocg_v, r,g,b, Y,Co,Cg)
ALWAN_MAP3_EX_V(alwan_ycocg_to_rgb_map_ex, alwan_ycocg, alwan_rgb, alwan_ycocg_to_rgb_v, Y,Co,Cg, r,g,b)
ALWAN_MAP3_EX_V(alwan_rgb_to_hwb_map_ex,   alwan_rgb, alwan_hwb, alwan_rgb_to_hwb_v, r,g,b, h,w,b)
ALWAN_MAP3_EX_V(alwan_hwb_to_rgb_map_ex,   alwan_hwb, alwan_rgb, alwan_hwb_to_rgb_v, h,w,b, r,g,b)
ALWAN_MAP3_EX_V(alwan_hsv_to_hwb_map_ex,   alwan_hsv, alwan_hwb, alwan_hsv_to_hwb_v, h,s,v, h,w,b)
ALWAN_MAP3_EX_V(alwan_hwb_to_hsv_map_ex,   alwan_hwb, alwan_hsv, alwan_hwb_to_hsv_v, h,w,b, h,s,v)
...
ALWAN_MAP3_EX_V_INT(alwan_rgb_to_yccbccrc_map_ex, alwan_rgb, alwan_yccbccrc, alwan_rgb_to_yccbccrc_v, int, bit_depth, r,g,b, Yc,Cbc,Crc)
ALWAN_MAP3_EX_V_INT(alwan_yccbccrc_to_rgb_map_ex, alwan_yccbccrc, alwan_rgb, alwan_yccbccrc_to_rgb_v, int, bit_depth, Yc,Cbc,Crc, r,g,b)
ALWAN_MAP3_EX_V_INT(alwan_ycbcr_full_to_legal_map_ex, alwan_ycbcr, alwan_ycbcr, alwan_ycbcr_full_to_legal_v, int, bit_depth, Y,Cb,Cr, Y,Cb,Cr)
ALWAN_MAP3_EX_V_INT(alwan_ycbcr_legal_to_full_map_ex, alwan_ycbcr, alwan_ycbcr, alwan_ycbcr_legal_to_full_v, int, bit_depth, Y,Cb,Cr, Y,Cb,Cr)

/* ----------------------------------------------------------------
 * Extended color spaces _ex (simple 3->3, using _v core functions)
 * ---------------------------------------------------------------- */

ALWAN_MAP3_EX_V(alwan_xyz_to_igpgtg_map_ex,     alwan_xyz,    alwan_igpgtg,    alwan_xyz_to_igpgtg_v,     x,y,z,    Ig,Pg,Tg)
ALWAN_MAP3_EX_V(alwan_igpgtg_to_xyz_map_ex,     alwan_igpgtg, alwan_xyz,       alwan_igpgtg_to_xyz_v,     Ig,Pg,Tg, x,y,z)
ALWAN_MAP3_EX_V(alwan_xyz_to_icacb_map_ex,      alwan_xyz,    alwan_icacb,     alwan_xyz_to_icacb_v,      x,y,z,    I,Ca,Cb)
ALWAN_MAP3_EX_V(alwan_icacb_to_xyz_map_ex,      alwan_icacb,  alwan_xyz,       alwan_icacb_to_xyz_v,      I,Ca,Cb,  x,y,z)
ALWAN_MAP3_EX_V(alwan_xyz_to_hdr_cielab_map_ex, alwan_xyz,    alwan_lab,       alwan_xyz_to_hdr_cielab_v, x,y,z,    L,a,b)
ALWAN_MAP3_EX_V(alwan_hdr_cielab_to_xyz_map_ex, alwan_lab,    alwan_xyz,       alwan_hdr_cielab_to_xyz_v, L,a,b,    x,y,z)
ALWAN_MAP3_EX_V(alwan_xyz_to_hdr_ipt_map_ex,    alwan_xyz,    alwan_ipt,       alwan_xyz_to_hdr_ipt_v,    x,y,z,    I,P,T)
ALWAN_MAP3_EX_V(alwan_hdr_ipt_to_xyz_map_ex,    alwan_ipt,    alwan_xyz,       alwan_hdr_ipt_to_xyz_v,    I,P,T,    x,y,z)
ALWAN_MAP3_EX_V(alwan_xyz_to_ucs_map_ex,        alwan_xyz,    alwan_ucs,       alwan_xyz_to_ucs_v,        x,y,z,    U,V,W)
ALWAN_MAP3_EX_V(alwan_ucs_to_xyz_map_ex,        alwan_ucs,    alwan_xyz,       alwan_ucs_to_xyz_v,        U,V,W,    x,y,z)
ALWAN_MAP3_EX_V(alwan_xyz_to_osa_ucs_map_ex,    alwan_xyz,    alwan_osa_ucs,   alwan_xyz_to_osa_ucs_v,    x,y,z,    L,j,g)
ALWAN_MAP3_EX_V(alwan_osa_ucs_to_xyz_map_ex,    alwan_osa_ucs,alwan_xyz,       alwan_osa_ucs_to_xyz_v,    L,j,g,    x,y,z)
ALWAN_MAP3_EX_V(alwan_xyz_to_hunter_lab_map_ex,  alwan_xyz,   alwan_hunter_lab, alwan_xyz_to_hunter_lab_v, x,y,z,    L,a,b)
ALWAN_MAP3_EX_V(alwan_hunter_lab_to_xyz_map_ex,  alwan_hunter_lab, alwan_xyz,   alwan_hunter_lab_to_xyz_v, L,a,b,    x,y,z)
ALWAN_MAP3_EX_V(alwan_xyz_to_prolab_map_ex,      alwan_xyz,   alwan_prolab,    alwan_xyz_to_prolab_v,     x,y,z,    L,a,b)
ALWAN_MAP3_EX_V(alwan_prolab_to_xyz_map_ex,      alwan_prolab, alwan_xyz,      alwan_prolab_to_xyz_v,     L,a,b,    x,y,z)
ALWAN_MAP3_EX_V(alwan_rgb_to_prismatic_map_ex,   alwan_rgb,   alwan_prismatic, alwan_rgb_to_prismatic_v,  r,g,b,    L,s,h)
ALWAN_MAP3_EX_V(alwan_prismatic_to_rgb_map_ex,   alwan_prismatic, alwan_rgb,   alwan_prismatic_to_rgb_v,  L,s,h,    r,g,b)
ALWAN_MAP3_EX_V(alwan_rgb_to_hcl_map_ex,         alwan_rgb,   alwan_hcl,      alwan_rgb_to_hcl_v,        r,g,b,    H,C,L)
ALWAN_MAP3_EX_V(alwan_hcl_to_rgb_map_ex,         alwan_hcl,   alwan_rgb,      alwan_hcl_to_rgb_v,        H,C,L,    r,g,b)
ALWAN_MAP3_EX_V(alwan_rgb_to_ihls_map_ex,        alwan_rgb,   alwan_ihls,     alwan_rgb_to_ihls_v,       r,g,b,    H,L,S)
ALWAN_MAP3_EX_V(alwan_ihls_to_rgb_map_ex,        alwan_ihls,  alwan_rgb,      alwan_ihls_to_rgb_v,       H,L,S,    r,g,b)

/* Extended _ex with white point */

ALWAN_MAP3_EX_V_WHITE(alwan_xyz_to_uvw_map_ex,              alwan_xyz, alwan_uvw,        alwan_xyz_to_uvw_v,                x,y,z, U,V,W)
ALWAN_MAP3_EX_V_WHITE(alwan_uvw_to_xyz_map_ex,              alwan_uvw, alwan_xyz,        alwan_uvw_to_xyz_v,                U,V,W, x,y,z)
ALWAN_MAP3_EX_V_WHITE(alwan_xyz_to_hunter_lab_custom_map_ex, alwan_xyz, alwan_hunter_lab, alwan_xyz_to_hunter_lab_custom_v, x,y,z, L,a,b)
ALWAN_MAP3_EX_V_WHITE(alwan_hunter_lab_to_xyz_custom_map_ex, alwan_hunter_lab, alwan_xyz, alwan_hunter_lab_to_xyz_custom_v, L,a,b, x,y,z)
ALWAN_MAP3_EX_V_WHITE(alwan_xyz_to_prolab_custom_map_ex,     alwan_xyz, alwan_prolab,    alwan_xyz_to_prolab_custom_v,     x,y,z, L,a,b)
ALWAN_MAP3_EX_V_WHITE(alwan_prolab_to_xyz_custom_map_ex,     alwan_prolab, alwan_xyz,    alwan_prolab_to_xyz_custom_v,     L,a,b, x,y,z)

/* DIN99 _ex (with int variant) */

ALWAN_MAP3_EX_V_INT(alwan_lab_to_din99_map_ex, alwan_lab, alwan_din99, alwan_lab_to_din99_v, int, variant, L,a,b, L99,a99,b99)
ALWAN_MAP3_EX_V_INT(alwan_din99_to_lab_map_ex, alwan_din99, alwan_lab, alwan_din99_to_lab_v, int, variant, L99,a99,b99, L,a,b)
...
ALWAN_MAP3_EX_V_SCALAR(alwan_simulate_protanopia_map_ex,   alwan_rgb, alwan_rgb, alwan_simulate_protanopia_v,   r,g,b, r,g,b)
ALWAN_MAP3_EX_V_SCALAR(alwan_simulate_deuteranopia_map_ex, alwan_rgb, alwan_rgb, alwan_simulate_deuteranopia_v, r,g,b, r,g,b)
ALWAN_MAP3_EX_V_SCALAR(alwan_simulate_tritanopia_map_ex,   alwan_rgb, alwan_rgb, alwan_simulate_tritanopia_v,   r,g,b, r,g,b)
