...
int alwan_rgb_to_ictcp_map(alwan_scalar *ictcp_out, alwan_scalar const *rgb_in,
...
int alwan_ictcp_to_rgb_map(alwan_scalar *rgb_out, alwan_scalar const *ictcp_in,
                            int use_pq, size_t count, size_t in_stride, size_t out_stride) {
...
int alwan_xyz_to_ictcp_map(alwan_scalar *ictcp_out, alwan_scalar const *xyz_in,
                            int use_pq, size_t count, size_t in_stride, size_t out_stride) {
...
int alwan_ictcp_to_xyz_map(alwan_scalar *xyz_out, alwan_scalar const *ictcp_in,
                            int use_pq, size_t count, size_t in_stride, size_t out_stride) {
