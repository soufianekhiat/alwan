...
ALWAN_INLINE alwan_cam20u_v_correlates alwan_cam20u_forward_v(
    ...
    alwan_scalar L_safe = ALWAN_SELECT(L_abs < ALWAN_LITERAL(1e-12),
                                        ALWAN_LITERAL(1e-12), L_abs);
    alwan_scalar M_safe = ALWAN_SELECT(M_abs < ALWAN_LITERAL(1e-12),
                                        ALWAN_LITERAL(1e-12), M_abs);
    alwan_scalar S_safe = ALWAN_SELECT(S_abs < ALWAN_LITERAL(1e-12),
                                        ALWAN_LITERAL(1e-12), S_abs);
...
ALWAN_INLINE alwan_xyz alwan_cam20u_inverse_v(
    ...
    alwan_scalar A = ALWAN_LITERAL(100.0) * ALWAN_POW(correlates.Q / ALWAN_LITERAL(11.0),
        ALWAN_ONE / safe_z);
