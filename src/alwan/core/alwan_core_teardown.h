...
#undef ALWAN_CORE_SRGB_OETF
#undef ALWAN_CORE_SRGB_EOTF
#undef ALWAN_CORE_BT2020_OETF
#undef ALWAN_CORE_BT2020_EOTF
#undef ALWAN_CORE_LN
#undef ALWAN_CORE_LOG2
#undef ALWAN_CORE_LOG10
#undef ALWAN_CORE_FLOOR
#undef ALWAN_CORE_ROUND
...
#undef ALWAN_CORE_PARAM_OUT
#undef ALWAN_CORE_REF
#undef ALWAN_CORE_ADDR
#undef ALWAN_CORE_PARAM_ARRAY_OUT
...
#undef ALWAN_CORE_CIECAM16_VIEWING_CONDITIONS
#undef ALWAN_CORE_SCAM_VIEWING_CONDITIONS
...
#undef ALWAN_CORE_CIECAM16_CORRELATES
#undef ALWAN_CORE_SCAM_CORRELATES
