...
ALWAN_INLINE alwan_oklab alwan_xyz_to_oklab_v(alwan_xyz xyz) {
    ...
    alwan_scalar l_ = ALWAN_CBRT(lms_v.v[0]);
    alwan_scalar m_ = ALWAN_CBRT(lms_v.v[1]);
    alwan_scalar s_ = ALWAN_CBRT(lms_v.v[2]);
    alwan_vec3 lms_p_v = {{l_, m_, s_}};
    alwan_vec3 lab_v = alwan_mat3_mulv_v(OKLAB_M2, lms_p_v);
    result.L = lab_v.v[0]; result.a = lab_v.v[1]; result.b = lab_v.v[2];
    return result;
}
...
ALWAN_INLINE alwan_xyz alwan_oklab_to_xyz_v(alwan_oklab oklab) {
    ...
    alwan_scalar l = lms_p_v.v[0] * lms_p_v.v[0] * lms_p_v.v[0];
    alwan_scalar m = lms_p_v.v[1] * lms_p_v.v[1] * lms_p_v.v[1];
    alwan_scalar s = lms_p_v.v[2] * lms_p_v.v[2] * lms_p_v.v[2];
