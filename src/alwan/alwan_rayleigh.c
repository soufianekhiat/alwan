...
#define AVOGADRO_CONSTANT           ALWAN_LITERAL(6.02214179e+23)   /* molecules/mol (CODATA value) */
#define STANDARD_AIR_TEMPERATURE    ALWAN_LITERAL(288.15)           /* K */
#define STANDARD_CO2_CONCENTRATION  ALWAN_LITERAL(300.0)            /* ppm */
#define AVERAGE_PRESSURE_SEA_LEVEL  ALWAN_LITERAL(101325.0)         /* Pa */
#define DEFAULT_LATITUDE            ALWAN_LITERAL(0.0)              /* degrees */
#define DEFAULT_ALTITUDE            ALWAN_LITERAL(0.0)              /* meters */
...
static alwan_scalar molecular_density(alwan_scalar temperature)
{
    ...
    return (AVOGADRO_CONSTANT / ALWAN_LITERAL(22.4141)) * (ALWAN_LITERAL(273.15) / temperature) * (ALWAN_LITERAL(1.0) / ALWAN_LITERAL(1000.0));
}
...
{
    alwan_scalar wl2_inv = ALWAN_LITERAL(1.0) / (wl_um * wl_um);
    alwan_scalar n;

    n = ALWAN_LITERAL(8060.51) + ALWAN_LITERAL(2480990.0) / (ALWAN_LITERAL(132.274) - wl2_inv) + ALWAN_LITERAL(17455.7) / (ALWAN_LITERAL(39.32957) - wl2_inv);
    n /= ALWAN_LITERAL(1.0e8);
    n += ALWAN_LITERAL(1.0);
                                                       ...
                                                       alwan_scalar CO2_ppm)
{
    ...
    return (ALWAN_LITERAL(1.0) + ALWAN_LITERAL(0.54) * (CO2_ppv - ALWAN_LITERAL(300.0e-6))) * (n_peck - ALWAN_LITERAL(1.0)) + ALWAN_LITERAL(1.0);
}
...
static alwan_scalar O2_depolarisation(alwan_scalar wl_um)
{
    ...
    return ALWAN_LITERAL(1.096) + ALWAN_LITERAL(1.385e-3) * wl2_inv + ALWAN_LITERAL(1.448e-4) * wl4_inv;
}
...
static alwan_scalar F_air_Bodhaine1999(alwan_scalar wl_um, alwan_scalar CO2_ppm)
{
    ...
    alwan_scalar F_air = (ALWAN_LITERAL(78.084) * N2 + ALWAN_LITERAL(20.946) * O2 + ALWAN_LITERAL(0.934) * ALWAN_LITERAL(1.0) + CO2_c * ALWAN_LITERAL(1.15)) /
                         (ALWAN_LITERAL(78.084) + ALWAN_LITERAL(20.946) + ALWAN_LITERAL(0.934) + CO2_c);
...
{
    alwan_scalar cos2phi = ALWAN_COS(ALWAN_LITERAL(2.0) * latitude * ALWAN_PI / ALWAN_LITERAL(180.0));

    /* Sea level acceleration of gravity */
    alwan_scalar g0 = ALWAN_LITERAL(980.6160) * (ALWAN_LITERAL(1.0) - ALWAN_LITERAL(0.0026373) * cos2phi + ALWAN_LITERAL(0.0000059) * cos2phi * cos2phi);
                                           ...
                                           alwan_atmosphere_params const *params)
{
    ...
    wl_cm = wavelength_nm * ALWAN_LITERAL(1.0e-7);
    wl_um = wl_cm * ALWAN_LITERAL(1.0e4);  /* cm to micrometers */
    ...
    n_s2 = n_s * n_s;
    n_s2_minus_1 = n_s2 - ALWAN_LITERAL(1.0);
    n_s2_plus_2 = n_s2 + ALWAN_LITERAL(2.0);

    sigma = ALWAN_LITERAL(24.0) * ALWAN_PI * ALWAN_PI * ALWAN_PI * (n_s2_minus_1 * n_s2_minus_1);
                                           ...
                                           alwan_atmosphere_params const *params)
{
    ...
    P_dyncm2 = pressure * ALWAN_LITERAL(10.0);
