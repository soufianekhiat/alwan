...
$dataScripts = @(
    @{Name="Chromatic Adaptation Matrices"; Script="../alwan_gendata/data/cat_matrices.py"; Priority=1},
    @{Name="Fairchild CAT Matrix"; Script="../alwan_gendata/data/cat_fairchild.py"; Priority=1},
    @{Name="CMCCat97 CAT Matrix"; Script="../alwan_gendata/data/cat_cmccat97.py"; Priority=1},
    @{Name="HPE Matrix"; Script="../alwan_gendata/data/hpe_matrix.py"; Priority=1},
    @{Name="Core Matrices (Oklab/Jzazbz)"; Script="../alwan_gendata/data/core_matrices.py"; Priority=1},
    @{Name="Vision LEFs (Photopic/Scotopic)"; Script="../alwan_gendata/data/vision_lefs.py"; Priority=1},
    @{Name="LLAB Matrices"; Script="../alwan_gendata/data/llab_matrices.py"; Priority=1},
    @{Name="IPT Data"; Script="../alwan_gendata/data/ipt_data.py"; Priority=1},
    @{Name="ProLab Data"; Script="../alwan_gendata/data/prolab_data.py"; Priority=1},
    @{Name="ICtCp Matrices"; Script="../alwan_gendata/data/ictcp_matrices.py"; Priority=1},
    @{Name="ACES Matrices"; Script="../alwan_gendata/data/aces_matrices.py"; Priority=1},
    @{Name="Illuminants"; Script="../alwan_gendata/data/illuminants.py"; Priority=1},
    @{Name="Illuminants (Extended)"; Script="../alwan_gendata/data/illuminants_extended.py"; Priority=1},
    @{Name="Color Matching Functions"; Script="../alwan_gendata/data/cmf.py"; Priority=1},
    @{Name="RGB Color Spaces"; Script="../alwan_gendata/data/rgb_spaces.py"; Priority=1},
    @{Name="RGB Space Matrices"; Script="../alwan_gendata/data/rgb_matrices.py"; Priority=1},
    @{Name="ARRI LogC3"; Script="../alwan_gendata/data/arri_logc3.py"; Priority=1},
    @{Name="Reference Data"; Script="../alwan_gendata/data/reference_data.py"; Priority=1},
    @{Name="Test Fixtures (Color Spaces)"; Script="../alwan_gendata/data/test_fixtures.py"; Priority=1},
    @{Name="Delta-E Fixtures"; Script="../alwan_gendata/data/delta_e_fixtures.py"; Priority=1},
    @{Name="Convenience Color Models"; Script="../alwan_gendata/data/convenience_color_models.py"; Priority=1},
    @{Name="Oklab Fixtures"; Script="../alwan_gendata/data/oklab_fixtures.py"; Priority=1},
    @{Name="CCT Fixtures"; Script="../alwan_gendata/data/cct_fixtures.py"; Priority=1},
    @{Name="Robertson CCT Table"; Script="../alwan_gendata/data/robertson_cct.py"; Priority=1},
    @{Name="Chromatic Adaptation Fixtures"; Script="../alwan_gendata/data/chromatic_adaptation_fixtures.py"; Priority=2},
    @{Name="CAM Fixtures (CIECAM02/CAM16)"; Script="../alwan_gendata/data/cam_fixtures.py"; Priority=2},
    @{Name="RGB Conversion Fixtures"; Script="../alwan_gendata/data/rgb_conversion_fixtures.py"; Priority=2},
    @{Name="Gamut Mapping Fixtures"; Script="../alwan_gendata/data/gamut_mapping_fixtures.py"; Priority=2},
    @{Name="Spectral Upsampling Basis"; Script="../alwan_gendata/data/spectral_upsampling.py"; Priority=2},
    @{Name="Jakob2019 LUTs (Spectral Upsampling)"; Script="../alwan_gendata/data/jakob2019_luts.py"; Priority=2},
    @{Name="Extended IPT/ICtCp Matrices"; Script="../alwan_gendata/data/ipt_ictcp_extended.py"; Priority=1},
    @{Name="Extended Color Spaces (IgPgTg/ICAcB/IHLS/HDR/Locus)"; Script="../alwan_gendata/data/extended_colorspaces.py"; Priority=1},
    ...
    @{Name="Machado 2009 CVD Matrices"; Script="../alwan_gendata/data/machado2009_matrices.py"; Priority=1},
...
Write-Host "  See ../alwan_gendata/PROGRESS.md for full status" -ForegroundColor Gray
