...
$testScripts = @(
    @{Name="Test Reference Values"; Script="../alwan_dev/gendata/data/test_reference_values.py"},
    @{Name="Machado 2009 CVD"; Script="../alwan_dev/gendata/tests/machado2009_cvd.py"},
    @{Name="Hellwig2022"; Script="../alwan_dev/gendata/tests/hellwig2022.py"},
    @{Name="Kim2009"; Script="../alwan_dev/gendata/tests/kim2009.py"},
    @{Name="LLAB"; Script="../alwan_dev/gendata/tests/llab.py"},
    @{Name="ATD95"; Script="../alwan_dev/gendata/tests/atd95.py"},
    @{Name="Zhai2018 CAM-UCS Delta E"; Script="../alwan_dev/gendata/tests/zhai2018_cam_ucs_delta_e.py"},
    @{Name="Polynomial Color Correction"; Script="../alwan_dev/gendata/tests/polynomial_color_correction.py"},
    @{Name="Rayleigh Scattering"; Script="../alwan_dev/gendata/tests/rayleigh_scattering.py"},
    @{Name="Barten 1999 CSF"; Script="../alwan_dev/gendata/tests/barten1999_csf.py"}
)

# ACES/OCIO test generation scripts (output to tests/reference_values/)
$acesScripts = @(
    @{Name="ACES Fixed Functions (RedMod, Glow, DarkToDim, GamutComp13)"; Script="../alwan_dev/gendata/tests/aces_fixed_functions.py"},
    @{Name="ACES 2.0 Section5/Section9 (TonescaleCompress, RGB-JMh, GamutCompress)"; Script="../alwan_dev/gendata/tests/section5_section9.py"},
    @{Name="ACES 2.0 TonescaleCompress Pipeline"; Script="../alwan_dev/gendata/tests/aces_tonescale_compress20.py"},
    @{Name="ACES 2.0 GamutCompress Pipeline"; Script="../alwan_dev/gendata/tests/aces_gamut_compress20.py"},
    @{Name="ACES 2.0 Output Transform (all presets)"; Script="../alwan_dev/gendata/tests/aces2_output_transform.py"},
    @{Name="ACES 1.x Output Transform (RRT+ODT)"; Script="../alwan_dev/gendata/tests/aces1_output_transform.py"},
    @{Name="CCT and Cineon"; Script="../alwan_dev/gendata/tests/cct_cineon.py"}
)
...
try {
    $output = cmd /c "python ../alwan_dev/gendata/data/cam_fixtures.py tests 2>&1"
